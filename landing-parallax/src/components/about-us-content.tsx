        ...
        <div className="mt-12 text-center">
          <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-lg mb-6 opacity-90">
              Únete a más de 100 empresas que ya están facturando 3X más con nuestras soluciones digitales
            </p>
            <a
              ...
              className="inline-flex items-center px-8 py-4 bg-white text-green-600 font-bold rounded-full hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
